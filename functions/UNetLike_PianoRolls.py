...
"""
the UNet_Pianoroll is a class to build a neural network inspired by Unet still keeping the residual layer in the bottleneck
"""
...
"""
the Autoencoder_Pianoroll is a class to build a neural network inspired by Unet but without the residual layers,
making the encoder and decoder completely separable
"""
...
class Autoencoder_Pianoroll(BaseEstimator, ClassifierMixin):
  ...
  def Encoder(self, img_size ):
    ...
    for filters in filters[1::]:
        ...
        # Project residual
        residual = layers.Conv2D(filters, 1, strides=2, padding="same", name= 'Enco_conv_filter'+str(filters)+'_4'
