# coding:utf-8
"""evaluation_MIDIs.py
Code taken and updated to python 3 from the following repository:
https://github.com/RichardYang40148/mgeval/tree/master
...
class metrics(object):
    ...
    def total_used_note(self, feature, track_num=1):
        ...
        pattern = feature['midi_pattern']
        used_notes = 0
        if len(pattern) < track_num:
            track_num =  len(pattern)
